...
export default function StatsRow({ teams, members, workAreas, sprints, allocations, selectedTeamId }) {
  ...
  const stats = [
    ...
    { label: "Mitglieder", value: filteredMembers.length, icon: Users, color: "text-emerald-600 bg-emerald-50" },
    { label: "Bereiche", value: workAreas.length, icon: FolderKanban, color: "text-purple-600 bg-purple-50" },
    { label: "⌀ Auslastung", value: `${avgUtil}%`, icon: TrendingUp, color: avgUtil > 100 ? "text-red-600 bg-red-50" : avgUtil > 80 ? "text-amber-600 bg-amber-50" : "text-blue-600 bg-blue-50" },
  ];
